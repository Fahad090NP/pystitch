...
def get_thread_set() -> List[Optional['EmbThreadSew']]:
    return [
...
class EmbThreadSew(EmbThread):
    def __init__(self, red: int, green: int, blue: int, description: str, catalog_number: str):
...
__all__ = ['EmbThreadSew', 'get_thread_set']
