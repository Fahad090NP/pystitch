...
def get_thread_set() -> List[Optional['EmbThreadHus']]:
    return [
...
class EmbThreadHus(EmbThread):
    def __init__(self, color: Union[int, str], description: str, catalog_number: Optional[str] = None):
...
__all__ = ['EmbThreadHus', 'get_thread_set']
